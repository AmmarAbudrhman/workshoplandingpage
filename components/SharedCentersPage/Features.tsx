...
const Features = () => {
  const innovations = [
    {
      title: "لوحة تحكم هندسية",
      description: "توفر رؤية واضحة لمدير الورشة عن أداء الفنيين والمهندسين وحالة الطلبات.",
      icon: <LayoutDashboard />,
    },
    {
      title: "نظام تتبع الصيانة",
      description: "متابعة دقيقة لكل مرحلة من مراحل العمل الهندسي بشكل فوري.",
      icon: <CheckCircle2 />,
    },
    {
      title: "تقارير الإنجاز",
      description: "تقارير تفصيلية لتحليل كفاءة العمل وتقدير التكاليف والجودة.",
      icon: <Trophy />,
    },
    {
      title: "إدارة المخزون والقطع",
      description: "نظام مؤتمت بالكامل لإدارة قطع الغيار والمعدات داخل الورشة.",
      icon: <Timer />,
    },
  ];
